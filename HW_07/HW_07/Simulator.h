...
public:
	...
	void show_stats()
	{
		...
		// FIXME:done Calculate and display the average wait time for the landing queue
		double average_landing_wait_time = landing_queue->get_total_wait() / landing_queue->get_num_served();
		std::cout << "The average landing waiting time in the landing queue is: " << average_landing_wait_time << std::endl;
		...
		// FIXME:done Calculate and display the average wait time for the departure queue
		double average_departure_wait_time = departure_queue->get_total_wait() / departure_queue->get_num_served();
		std::cout << " The average wait time for the departure queue is: " << average_departure_wait_time << std::endl;
		std::cout << std::endl;
